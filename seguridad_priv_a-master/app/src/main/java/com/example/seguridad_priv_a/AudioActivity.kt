...
class AudioActivity : AppCompatActivity() {
    ...
    private fun updatePermissionStatus() {
        ...
        binding.btnRequestPermission.visibility = if (hasPermission) View.GONE else View.VISIBLE
    }
    ...
    private fun startRecording() {
        ...
        // Simula grabación por 5 segundos
        ...
        dataProtectionManager.storeSecureDataWithIntegrity(
            "last_recording_time",
            System.currentTimeMillis().toString(),
            "usuario123" // reemplaza con el ID real del usuario si lo tienes
        )
